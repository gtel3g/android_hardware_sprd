                           ...
                           int operation, ...)
{
    ...
    switch (operation) {
        ...
        case GRALLOC1_ADAPTER_PERFORM_SET_USAGES:
        {
            ...
            /*
             * alloc_device_alloc() already stores the converted
             * gralloc0 usage in hnd->usage. Keep the legacy handle
             * ABI unchanged for the Mali-400 blob.
             */
            (void)hnd;
            (void)producerUsage;
            (void)consumerUsage;
        ...
        case GRALLOC1_ADAPTER_PERFORM_GET_BACKING_STORE:
        {
            ...
            /*
             * Gralloc1 only needs a stable identifier for this
             * backing store in the current process.
             */
            *outBackingStore =
                static_cast<uint64_t>(
                    reinterpret_cast<uintptr_t>(hnd));
...
#ifdef ADVERTISE_GRALLOC1
	base.common.module_api_version =
		GRALLOC1_ADAPTER_MODULE_API_VERSION_1_0;
#else
	/*
	 * This is a legacy gralloc0 module.
	 *
	 * Do not advertise major API 1 here: Android's HIDL
	 * GrallocLoader interprets major 1 as gralloc1 and will
	 * treat alloc_device_t as gralloc1_device_t.
	 *
	 * This implementation provides the gralloc0.2 interface
	 * including lock_ycbcr, but not the 0.3 async callbacks.
	 */
	base.common.module_api_version =
